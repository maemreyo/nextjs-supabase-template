...
function DialogContent({
  ...
  const getSizeClasses = () => {
    switch (size) {
      case "large":
        return "max-w-[95vw] sm:max-w-4xl md:max-w-5xl lg:max-w-5xl xl:max-w-6xl max-h-[90vh]";
      case "xlarge":
        return "max-w-[95vw] sm:max-w-6xl md:max-w-7xl lg:max-w-7xl xl:max-w-7xl max-h-[95vh]";
      case "xxlarge":
    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          getSizeClasses(),
          getPositionClasses(),
          size !== "fullscreen" && "rounded-lg p-6",
          size === "fullscreen" && "p-0",
          className
        )}
        {...props}
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className={cn(
              ...
              size === "fullscreen" ? "top-4 right-4" : "top-4 right-4"
            )}
          >
            <XIcon />
