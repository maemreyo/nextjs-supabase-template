...
interface WordPhoneticPronunciationAudioPlayerProps {
  word: string;
  ipa?: string;
...
/**
 * Word Phonetic Pronunciation Audio Player Component
 * Phát âm từ với các tùy chọn tùy chỉnh và hiển thị trạng thái
 */
export const WordPhoneticPronunciationAudioPlayer: React.FC<WordPhoneticPronunciationAudioPlayerProps> = ({
  word,
  ipa,
  onPronounce,
  className,
  ...
  useEffect(() => {
    if (autoPlay && word && isSupported) {
      handlePronounce();
    }
  }, [autoPlay, word, isSupported]);
  ...
  return (
    <div className={cn('flex items-center gap-3', className)}>
      ...
      <Button
        ...
        aria-label={isPlaying ? `Dừng phát âm ${word}` : `Phát âm ${word}`}
...
export default WordPhoneticPronunciationAudioPlayer;